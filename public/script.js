...
<div class="mb-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button onclick="RoomManager.generateRandomCode()" class="bg-gray-100 hover:bg-indigo-100 text-indigo-600 font-bold px-4 rounded-xl border-2 border-gray-200 hover:border-indigo-200 transition-colors flex items-center gap-2 whitespace-nowrap text-sm">
                                    <span>🎲</span> Random Code
                                </button>
                            </div>
                        </div>
