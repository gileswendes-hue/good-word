        ...
        const BatAI = {
            ...
            createTrailingRing(x, y, maxRadius, duration) {
                ...
                Object.assign(ring.style, {
                    ...
                    transform: 'translate(-50%, -50%)', pointerEvents: 'none', zIndex: '4998'
                });
                document.body.appendChild(ring);
            ...
            createBounceRipple(x, y) {
                ...
                const animateRipple = (timestamp) => {
                    ...
                    if (progress < 1) requestAnimationFrame(animateRipple);
                    else ripple.remove();
                };
            ...
            tryHunt() {
                ...
                if (MosquitoManager.state === 'flying') {
                    ...
                    // Increased detection range (was 55, now 70)
                    if (distance < 70) {
            ...
            triggerSpiderAnger() {
                ...
                if (floorAI && floorAI.element && floorAI.element.style.display !== 'none') {
                    setTimeout(() => { floorAI.say('batStoleReaction'); }, 2000);
                }
            ...
            leave() {
                ...
                this.flightPath = [{ ...exits[0], exit: true, speed: 0.3 }];
                this.pathIndex = 0;
                this.fly();
            },
